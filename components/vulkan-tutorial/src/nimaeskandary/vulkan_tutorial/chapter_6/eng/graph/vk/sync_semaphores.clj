(ns nimaeskandary.vulkan-tutorial.chapter-6.eng.graph.vk.sync-semaphores
  (:require [nimaeskandary.vulkan-tutorial.chapter-6.eng.proto.semaphore :as
             proto.semaphore]
            [nimaeskandary.vulkan-tutorial.chapter-6.eng.graph.vk.semaphore :as
             vk.semaphore]
            [nimaeskandary.vulkan-tutorial.chapter-6.eng.proto.sync-semaphores
