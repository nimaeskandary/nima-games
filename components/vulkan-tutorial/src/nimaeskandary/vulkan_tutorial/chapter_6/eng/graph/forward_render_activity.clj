(ns nimaeskandary.vulkan-tutorial.chapter-6.eng.graph.forward-render-activity
  (:require
    [nimaeskandary.vulkan-tutorial.chapter-6.eng.proto.command-buffer :as
     proto.command-buffer]
    [nimaeskandary.vulkan-tutorial.chapter-6.eng.proto.fence :as proto.fence]
    [nimaeskandary.vulkan-tutorial.chapter-6.eng.proto.frame-buffer :as
     proto.frame-buffer]
    ...
    [nimaeskandary.vulkan-tutorial.chapter-6.eng.proto.forward-render-activity
