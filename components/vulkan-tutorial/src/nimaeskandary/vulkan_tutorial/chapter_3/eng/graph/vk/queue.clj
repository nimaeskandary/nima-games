(ns nimaeskandary.vulkan-tutorial.chapter-3.eng.graph.vk.queue
  (:require
    ...
    [nimaeskandary.vulkan-tutorial.chapter-3.eng.proto.queue :as proto.queue])
...
;; queues were pre created when the logical device was created, when the logical
