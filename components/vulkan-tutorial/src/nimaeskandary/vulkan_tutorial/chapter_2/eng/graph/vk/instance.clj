(ns nimaeskandary.vulkan-tutorial.chapter-2.eng.graph.vk.instance
  (:require [clojure.set :as set]
            [nimaeskandary.vulkan-tutorial.chapter-2.eng.graph.vk.vulkan-utils
             :as vulkan-utils]
...
(defn get-instance-exts
  ...
  (with-open [stack (MemoryStack/stackPush)]
    (let [num-exts-buff (.callocInt stack 1)
          ...
          _ (vk-enumerate-instance-extension-properties nil num-exts-buff props-buff)]
